...
Pada tahap ini, sistem menjalankan pengujian fitur pembaruan data (Update) melalui opsi 3 untuk mengubah durasi sewa pada transaksi RNT-03 dari yang semula 6 hari menjadi 9 hari. Nilai baru tersebut diproses melalui method updateLamaSewa pada SkateboardService dan divalidasi oleh setter kelas Penyewa sebelum memori diperbarui(Encapsulation). Setelah notifikasi keberhasilan ditampilkan, pengguna kembali memilih opsi 2 (Read) untuk memverifikasi perubahan data. Tampilan konsol mengonfirmasi bahwa atribut durasi sewa pada data rental milik Luthfi telah berubah menjadi 9 hari, dan sistem secara otomatis mengkalkulasi ulang total biaya menjadi Rp 594000.0 hasil perkalian tarif harian Rp 66000.0 dengan durasi baru tersebut.
